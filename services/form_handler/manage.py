...
def seed_db():
    ...
    db.session.add(FoodType(name='Duck pellets', catid=3, isvisible=True))
    db.session.add(FoodType(name='Lettuce', catid=4, isvisible=True))
    db.session.add(FoodType(name='Other', catid=4, isvisible=True))
    db.session.add(FoodType(name='Rolled', catid=5, isvisible=True))
    db.session.add(FoodType(name='Instant', catid=5, isvisible=True))
    db.session.add(FoodType(name='Frozen', catid=6, isvisible=True))
    db.session.add(FoodType(name='Fresh', catid=6, isvisible=True))
